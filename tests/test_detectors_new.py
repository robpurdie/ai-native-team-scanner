...
from scanner.detectors import FileTypeDetector, CommitPatternDetector
...
class TestFileTypeDetectorImprovements:
    ...
    def test_detects_ruby_minitest_test_suffix(self):
    ...
    def test_detects_ruby_minitest_test_directory(self):
    ...
    def test_detects_java_tests_plural(self):
    ...
    def test_detects_java_src_test_directory(self):
    ...
    def test_detects_python_spec_files(self):
    ...
    def test_detects_js_mjs_extension(self):
    ...
    def test_detects_ts_tsx_tests(self):
    ...
    # C# patterns
    def test_detects_csharp_tests(self):
    ...
    # PHP patterns
    def test_detects_php_tests(self):
...
class TestCommitPatternDetectorImprovements:
    ...
    def test_detects_verbose_conventional_commit(self):
    ...
    def test_detects_detailed_refactor(self):
        """Test detection of detailed refactor commits."""
        message = "refactor: Optimize database query performance by adding proper indexes and implementing query result caching"
        assert CommitPatternDetector.is_ai_assisted(message)

    # Multiple sentences (AI pattern)
    def test_detects_multi_sentence_commits(self):
        """Test detection of commits with multiple sentences."""
        message = "fix: Resolve authentication timeout issue. This fixes the problem by extending the session timeout to 30 minutes."
        assert CommitPatternDetector.is_ai_assisted(message)

    def test_detects_commits_with_connectors(self):
        """Test detection of commits with sentence connectors."""
        message = "feat: Add user profile page. Additionally, this includes avatar upload functionality."
        assert CommitPatternDetector.is_ai_assisted(message)

    # Bullet points (AI pattern)
    def test_detects_commits_with_bullets(self):
...
- Add notification panel"""
    ...
    def test_detects_error_handling_improvements(self):
    ...
    def test_still_detects_explicit_tool_mentions(self):
    ...
    def test_no_false_positive_on_simple_commits(self):
    ...
    def test_no_false_positive_on_normal_conventional(self):
